...
Mac OS X will work. UNIX-based OS should work (the only problem is EDITOR is textmate).
...
name shows up in the prompt while in a git repository.
  ...
  -==[pitr-home]=-=[release*_[2]]=-=[~/code/config_files]==-
...
Helpers form http://reinh.com/blog/2008/08/27/hack-and-and-ship.html
